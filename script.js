...
alert("Don't forget to hit a like if it deserves it.. ☺️\n🌸🌼Thanks to sololearn for code of the day and sololearners for 1.9k likes..🌸🌼😊");
...
function msg(){
 window.location.href = "sms:+254748963275?body=hi%2C%20this%20is%20@n0nym0u§%20code";
}
function sl(){
...
var scrollTop = $("#container").scrollTop();
   if (scrollTop < 150) {
       var maxHeight = 150 - 75 * ((scrollTop - 100)) / 200;
    }
    $('#slider1').css({
